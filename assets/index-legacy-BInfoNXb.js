...
/**
       ...
       * @license MIT
       */
function Zk(){return Zk=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Zk.apply(this,arguments)}new Set(Jk);const e_=z.createContext(null),t_=z.createContext(null),n_=z.createContext(null),r_=z.createContext(null),i_=z.createContext({outlet:null,matches:[],isDataRoute:!1}),s_=z.createContext(null);function a_(){return null!=z.useContext(r_)}function o_(){return a_()||Sk(!1),z.useContext(r_).location}function l_(e){z.useContext(n_).static||z.useLayoutEffect(e)}function u_(){let{isDataRoute:e}=z.useContext(i_);return e?function(){let{router:e}=function(){let e=z.useContext(e_);return e||Sk(!1),e}(g_.UseNavigateStable),t=y_(v_.UseNavigateStable),n=z.useRef(!1);l_((()=>{n.current=!0}));let r=z.useCallback((function(r,i){void 0===i&&(i={}),n.current&&("number"==typeof r?e.navigate(r):e.navigate(r,Zk({fromRouteId:t},i)))}),[e,t]);return r}():function(){a_()||Sk(!1);let e=z.useContext(e_),{basename:t,future:n,navigator:r}=z.useContext(n_),{matches:i}=z.useContext(i_),{pathname:s}=o_(),a=JSON.stringify(Hk(i,n.v7_relativeSplatPath)),o=z.useRef(!1);return l_((()=>{o.current=!0})),z.useCallback((function(n,i){if(void 0===i&&(i={}),!o.current)return;if("number"==typeof n)return void r.go(n);let l=Wk(n,JSON.parse(a),s,"path"===i.relative);null==e&&"/"!==t&&(l.pathname="/"===l.pathname?t:Kk([t,l.pathname])),(i.replace?r.replace:r.push)(l,i.state,i)}),[t,r,a,s,e])}()}const c_=z.createContext(null);function h_(e,t){return function(e,t,n,r){a_()||Sk(!1);let{navigator:i}=z.useContext(n_),{matches:s}=z.useContext(i_),a=s[s.length-1],o=a?a.params:{};!a||a.pathname;let l=a?a.pathnameBase:"/";a&&a.route;let u,c=o_();if(t){var h;let e="string"==typeof t?Ck(t):t;"/"===l||(null==(h=e.pathname)?void 0:h.startsWith(l))||Sk(!1),u=e}else u=c;let d=u.pathname||"/",f=d;if("/"!==l){let e=l.replace(/^\//,"").split("/");f="/"+d.replace(/^\//,"").split("/").slice(e.length).join("/")}let p=Ak(e,{pathname:f}),m=function(e,t,n,r){var i,s;if(void 0===t&&(t=[]),void 0===n&&(n=null),void 0===r&&(r=null),null==e){if(null==(s=n)||!s.errors)return null;e=n.matches}let a=e,o=null==(i=n)?void 0:i.errors;if(null!=o){let e=a.findIndex((e=>e.route.id&&void 0!==(null==o?void 0:o[e.route.id])));e>=0||Sk(!1),a=a.slice(0,Math.min(a.length,e+1))}let l=!1,u=-1;if(n&&r&&r.v7_partialHydration)for(let c=0;c<a.length;c++){let e=a[c];if((e.route.HydrateFallback||e.route.hydrateFallbackElement)&&(u=c),e.route.id){let{loaderData:t,errors:r}=n,i=e.route.loader&&void 0===t[e.route.id]&&(!r||void 0===r[e.route.id]);if(e.route.lazy||i){l=!0,a=u>=0?a.slice(0,u+1):[a[0]];break}}}return a.reduceRight(((e,r,i)=>{let s,c=!1,h=null,d=null;n&&(s=o&&r.route.id?o[r.route.id]:void 0,h=r.route.errorElement||f_,l&&(u<0&&0===i?(c=!0,d=null):u===i&&(c=!0,d=r.route.hydrateFallbackElement||null)));let f=t.concat(a.slice(0,i+1)),p=()=>{let t;return t=s?h:c?d:r.route.Component?z.createElement(r.route.Component,null):r.route.element?r.route.element:e,z.createElement(m_,{match:r,routeContext:{outlet:e,matches:f,isDataRoute:null!=n},children:t})};return n&&(r.route.ErrorBoundary||r.route.errorElement||0===i)?z.createElement(p_,{location:n.location,revalidation:n.revalidation,component:h,error:s,children:p(),routeContext:{outlet:null,matches:f,isDataRoute:!0}}):p()}),null)}(p&&p.map((e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Kk([l,i.encodeLocation?i.encodeLocation(e.pathname).pathname:e.pathname]),pathnameBase:"/"===e.pathnameBase?l:Kk([l,i.encodeLocation?i.encodeLocation(e.pathnameBase).pathname:e.pathnameBase])}))),s,n,r);return t&&m?z.createElement(r_.Provider,{value:{location:Zk({pathname:"/",search:"",hash:"",state:null,key:"default"},u),navigationType:wk.Pop}},m):m}(e,t)}function d_(){let e=function(){var e;let t=z.useContext(s_),n=function(){let e=z.useContext(t_);return e||Sk(!1),e}(v_.UseRouteError),r=y_(v_.UseRouteError);return void 0!==t?t:null==(e=n.errors)?void 0:e[r]}(),t=function(e){return null!=e&&"number"==typeof e.status&&"string"==typeof e.statusText&&"boolean"==typeof e.internal&&"data"in e}(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return z.createElement(z.Fragment,null,z.createElement("h2",null,"Unexpected Application Error!"),z.createElement("h3",{style:{fontStyle:"italic"}},t),n?z.createElement("pre",{style:r},n):null,null)}const f_=z.createElement(d_,null);class p_ extends z.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||"idle"!==t.revalidation&&"idle"===e.revalidation?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:void 0!==e.error?e.error:t.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){console.error("React Router caught the following error during render",e,t)}render(){return void 0!==this.state.error?z.createElement(i_.Provider,{value:this.props.routeContext},z.createElement(s_.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function m_(e){let{routeContext:t,match:n,children:r}=e,i=z.useContext(e_);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),z.createElement(i_.Provider,{value:t},r)}var g_=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(g_||{}),v_=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(v_||{});function y_(e){let t=function(){let e=z.useContext(i_);return e||Sk(!1),e}(),n=t.matches[t.matches.length-1];return n.route.id||Sk(!1),n.route.id}function w_(e){let{to:t,replace:n,state:r,relative:i}=e;a_()||Sk(!1);let{future:s,static:a}=z.useContext(n_),{matches:o}=z.useContext(i_),{pathname:l}=o_(),u=u_(),c=Wk(t,Hk(o,s.v7_relativeSplatPath),l,"path"===i),h=JSON.stringify(c);return z.useEffect((()=>u(JSON.parse(h),{replace:n,state:r,relative:i})),[u,h,i,n,r]),null}function b_(e){return function(e){let t=z.useContext(i_).outlet;return t?z.createElement(c_.Provider,{value:e},t):t}(e.context)}function E_(e){Sk(!1)}function S_(e){let{basename:t="/",children:n=null,location:r,navigationType:i=wk.Pop,navigator:s,static:a=!1,future:o}=e;a_()&&Sk(!1);let l=t.replace(/^\/*/,"/"),u=z.useMemo((()=>({basename:l,navigator:s,static:a,future:Zk({v7_relativeSplatPath:!1},o)})),[l,o,s,a]);"string"==typeof r&&(r=Ck(r));let{pathname:c="/",search:h="",hash:d="",state:f=null,key:p="default"}=r,m=z.useMemo((()=>{let e=qk(c,l);return null==e?null:{location:{pathname:e,search:h,hash:d,state:f,key:p},navigationType:i}}),[l,c,h,d,f,p,i]);return null==m?null:z.createElement(n_.Provider,{value:u},z.createElement(r_.Provider,{children:n,value:m}))}function k_(e){let{children:t,location:n}=e;return h_(__(t),n)}function __(e,t){void 0===t&&(t=[]);let n=[];return z.Children.forEach(e,((e,r)=>{if(!z.isValidElement(e))return;let i=[...t,r];if(e.type===z.Fragment)return void n.push.apply(n,__(e.props.children,i));e.type!==E_&&Sk(!1),e.props.index&&e.props.children&&Sk(!1);let s={id:e.props.id||i.join("-"),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,loader:e.props.loader,action:e.props.action,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:null!=e.props.ErrorBoundary||null!=e.props.errorElement,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(s.children=__(e.props.children,i)),n.push(s)})),n}
/**
...
/*! *****************************************************************************
      ...
      ***************************************************************************** */function Q_(e,t,n,r){return new(n||(n=Promise))((function(t,i){function s(e){try{o(r.next(e))}catch(nI){i(nI)}}function a(e){try{o(r.throw(e))}catch(nI){i(nI)}}function o(e){var r;e.done?t(e.value):(r=e.value,r instanceof n?r:new n((function(e){e(r)}))).then(s,a)}o((r=r.apply(e,[])).next())}))}function Y_(e,t){var n,r,i,s,a={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return s={next:o(0),throw:o(1),return:o(2)},"function"==typeof Symbol&&(s[Symbol.iterator]=function(){return this}),s;function o(s){return function(o){return function(s){if(n)throw new TypeError("Generator is already executing.");for(;a;)try{if(n=1,r&&(i=2&s[0]?r.return:s[0]?r.throw||((i=r.return)&&i.call(r),0):r.next)&&!(i=i.call(r,s[1])).done)return i;switch(r=0,i&&(s=[2&s[0],i.value]),s[0]){case 0:case 1:i=s;break;case 4:return a.label++,{value:s[1],done:!1};case 5:a.label++,r=s[1],s=[0];continue;case 7:s=a.ops.pop(),a.trys.pop();continue;default:if(!((i=(i=a.trys).length>0&&i[i.length-1])||6!==s[0]&&2!==s[0])){a=0;continue}if(3===s[0]&&(!i||s[1]>i[0]&&s[1]<i[3])){a.label=s[1];break}if(6===s[0]&&a.label<i[1]){a.label=i[1],i=s;break}if(i&&a.label<i[2]){a.label=i[2],a.ops.push(s);break}i[2]&&a.ops.pop(),a.trys.pop();continue}s=t.call(e,a)}catch(nI){s=[6,nI],r=0}finally{n=i=0}if(5&s[0])throw s[1];return{value:s[0]?s[1]:void 0,done:!0}}([s,o])}}}
/*! *****************************************************************************
      Copyright (c) Microsoft Corporation.
      ...
      OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
      PERFORMANCE OF THIS SOFTWARE.
      ***************************************************************************** */var X_=function(){return X_=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},X_.apply(this,arguments)},J_=function(e){return{loading:null==e,value:e}},Z_=function(e){var t=e?e():void 0,n=z.useReducer((function(e,t){switch(t.type){case"error":return X_(X_({},e),{error:t.error,loading:!1,value:void 0});case"reset":return J_(t.defaultValue);case"value":return X_(X_({},e),{error:void 0,loading:!1,value:t.value});default:return e}}),J_(t)),r=n[0],i=n[1],s=z.useCallback((function(){var t=e?e():void 0;i({type:"reset",defaultValue:t})}),[e]),a=z.useCallback((function(e){i({type:"error",error:e})}),[]),o=z.useCallback((function(e){i({type:"value",value:e})}),[]);return z.useMemo((function(){return{error:r.error,loading:r.loading,reset:s,setError:a,setValue:o,value:r.value}}),[r.error,r.loading,s,a,o,r.value])},eI=function(e,t){var n=Z_((function(){return e.currentUser})),r=n.error,i=n.loading,s=n.setError,a=n.setValue,o=n.value;return z.useEffect((function(){var n=function(e,t,n,r){return Mh(e).onAuthStateChanged(t,n,r)}(e,(function(e){return Q_(void 0,0,void 0,(function(){var n;return Y_(this,(function(r){switch(r.label){case 0:return[3,4];case 1:return r.trys.push([1,3,,4]),[4,t.onUserChanged(e)];case 2:return r.sent(),[3,4];case 3:return n=r.sent(),s(n),[3,4];case 4:return a(e),[2]}}))}))}),s);return function(){n()}}),[e]),[o,i,r]};function tI(){const[e]=eI(gk);return z.useEffect((()=>{console.log("user: ",e)}),[e]),X.jsx("div",{className:"wrapper",children:X.jsx(G_,{user:e})})}J.createRoot(document.getElementById("root")).render(X.jsx(B.StrictMode,{children:X.jsx(tI,{})}))}}}));
