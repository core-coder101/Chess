...
/**
       ...
       * limitations under the License.
       */
class dd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const fd="@firebase/app",pd="0.10.7",md=new Wh("@firebase/app"),gd="@firebase/app-compat",vd="@firebase/analytics-compat",yd="@firebase/analytics",wd="@firebase/app-check-compat",bd="@firebase/app-check",Ed="@firebase/auth",Sd="@firebase/auth-compat",_d="@firebase/database",kd="@firebase/database-compat",Id="@firebase/functions",Td="@firebase/functions-compat",Cd="@firebase/installations",xd="@firebase/installations-compat",Ad="@firebase/messaging",Nd="@firebase/messaging-compat",Pd="@firebase/performance",Rd="@firebase/performance-compat",Od="@firebase/remote-config",Dd="@firebase/remote-config-compat",Ld="@firebase/storage",Md="@firebase/storage-compat",Ud="@firebase/firestore",Fd="@firebase/vertexai-preview",jd="@firebase/firestore-compat",Vd="firebase",zd="[DEFAULT]",Bd={[fd]:"fire-core",[gd]:"fire-core-compat",[yd]:"fire-analytics",[vd]:"fire-analytics-compat",[bd]:"fire-app-check",[wd]:"fire-app-check-compat",[Ed]:"fire-auth",[Sd]:"fire-auth-compat",[_d]:"fire-rtdb",[kd]:"fire-rtdb-compat",[Id]:"fire-fn",[Td]:"fire-fn-compat",[Cd]:"fire-iid",[xd]:"fire-iid-compat",[Ad]:"fire-fcm",[Nd]:"fire-fcm-compat",[Pd]:"fire-perf",[Rd]:"fire-perf-compat",[Od]:"fire-rc",[Dd]:"fire-rc-compat",[Ld]:"fire-gcs",[Md]:"fire-gcs-compat",[Ud]:"fire-fst",[jd]:"fire-fst-compat",[Fd]:"fire-vertex","fire-js":"fire-js",[Vd]:"fire-js-all"},qd=new Map,$d=new Map,Hd=new Map;function Wd(e,t){try{e.container.addComponent(t)}catch(n){md.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Kd(e){const t=e.name;if(Hd.has(t))return md.debug(`There were multiple attempts to register component ${t}.`),!1;Hd.set(t,e);for(const n of qd.values())Wd(n,e);for(const n of $d.values())Wd(n,e);return!0}function Gd(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function Qd(e){return void 0!==e.settings}
/**
       * @license
       * Copyright 2019 Google LLC
       *
...
/**
       ...
       * See the License for the specific language governing permissions and
       * limitations under the License.
       */(e)}?${xh(o).slice(1)}${u}`}const Gm="webStorageSupport",Qm=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Kp,this._completeRedirectFn=Sm,this._overrideRedirectResult=Em}async _openPopup(e,t,n,r){var i;return xf(null===(i=this.eventManagers[e._key()])||void 0===i?void 0:i.manager,"_initialize() not called before _openPopup()"),qm(e,await Km(e,t,n,Af(),r),Qp())}async _openRedirect(e,t,n,r){return await this._originValidation(e),function(e){Xp().location.href=e}(await Km(e,t,n,Af(),r)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(xf(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await Vm(e),n=new _m(e);return t.register("authEvent",(t=>(Tf(null==t?void 0:t.authEvent,e,"invalid-auth-event"),{status:n.onEvent(t.authEvent)?"ACK":"ERROR"})),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Gm,{type:Gm},(n=>{var r;const i=null===(r=null==n?void 0:n[0])||void 0===r?void 0:r[Gm];void 0!==i&&t(!!i),Ef(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=xm(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return yp()||cp()||gp()}};var Ym="@firebase/auth",Xm="1.7.5";
/**
       * @license
       * Copyright 2020 Google LLC
       *
...
/*! *****************************************************************************
      ...
      OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
      PERFORMANCE OF THIS SOFTWARE.
      ***************************************************************************** */var Xk=function(){return Xk=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},Xk.apply(this,arguments)},Jk=function(e){return{loading:null==e,value:e}},Zk=function(e){var t=e?e():void 0,n=z.useReducer((function(e,t){switch(t.type){case"error":return Xk(Xk({},e),{error:t.error,loading:!1,value:void 0});case"reset":return Jk(t.defaultValue);case"value":return Xk(Xk({},e),{error:void 0,loading:!1,value:t.value});default:return e}}),Jk(t)),r=n[0],i=n[1],s=z.useCallback((function(){var t=e?e():void 0;i({type:"reset",defaultValue:t})}),[e]),a=z.useCallback((function(e){i({type:"error",error:e})}),[]),o=z.useCallback((function(e){i({type:"value",value:e})}),[]);return z.useMemo((function(){return{error:r.error,loading:r.loading,reset:s,setError:a,setValue:o,value:r.value}}),[r.error,r.loading,s,a,o,r.value])},eI=function(e,t){var n=Zk((function(){return e.currentUser})),r=n.error,i=n.loading,s=n.setError,a=n.setValue,o=n.value;return z.useEffect((function(){var n=function(e,t,n,r){return Mh(e).onAuthStateChanged(t,n,r)}(e,(function(e){return Qk(void 0,0,void 0,(function(){var n;return Yk(this,(function(r){switch(r.label){case 0:return[3,4];case 1:return r.trys.push([1,3,,4]),[4,t.onUserChanged(e)];case 2:return r.sent(),[3,4];case 3:return n=r.sent(),s(n),[3,4];case 4:return a(e),[2]}}))}))}),s);return function(){n()}}),[e]),[o,i,r]};function tI(){const[e]=eI(g_);return z.useEffect((()=>{console.log("user: ",e)}),[e]),X.jsx("div",{className:"wrapper",children:X.jsx(Gk,{user:e})})}J.createRoot(document.getElementById("root")).render(X.jsx(B.StrictMode,{children:X.jsx(tI,{})}))}}}));
